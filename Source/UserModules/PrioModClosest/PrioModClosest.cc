#include "PrioModClosest.h"
#include <math.h>

using namespace ikaros;

float
PrioModClosest::dist(float x1, float y1, float z1, float x2, float y2, float z2){
  float d;
...
static InitClass init("PrioModClosest", &PrioModClosest::Create, "Source/UserModules/PrioModClosest/");
